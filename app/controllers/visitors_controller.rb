class VisitorsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @visitor.update(visitor_params)
        format.html { redirect_to @visitor, notice: "Visitor was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to visitors_path, notice: "Visitor was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def visitor_params
      params.expect(visitor: [ :cpf, :name, :rg, :telephone, :photo ])
    end
end
